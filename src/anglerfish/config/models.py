...
class OllamaConfig(BaseModel):
    ...
    def _strip_ipv6_brackets(host: str) -> str:
        # pydantic's HttpUrl returns IPv6 hosts wrapped in square brackets;
        # ipaddress.ip_address rejects the bracket form.
    ...
    def _host_is_loopback(host: str) -> bool:
        ...
        try:
            return ipaddress.ip_address(
                OllamaConfig._strip_ipv6_brackets(host),
            ).is_loopback
        except ValueError:
            return False
    ...
    def _parse_host_as_ip(
        ...
        try:
            return ipaddress.ip_address(OllamaConfig._strip_ipv6_brackets(host))
        except ValueError:
            return None
