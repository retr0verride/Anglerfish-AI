...
configuration, the LLM bridge that drives the fake shell, the threat-scoring
engine, the Splunk forwarder, the dashboard, the credential intelligence
store, and the first-boot wizard. Each subsystem is shipped as a sub-package
of :mod:`anglerfish`.
