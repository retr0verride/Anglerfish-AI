...
to restart the bridge and Cowrie afterwards because the shared secret
changes.
"""
...
class WizardAnswers(BaseModel):
    ...
    vm_hostname: str = Field(
        ...
        min_length=1,
        max_length=63,
        description="Host operating-system hostname (not Cowrie's fake hostname).",
    )
    ...
    splunk_hec_url: HttpUrl | None = None
    splunk_hec_token: str | None = Field(default=None, min_length=8, max_length=512)
